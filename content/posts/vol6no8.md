---
title: "Pop Loser Vol. 6, No. 8 - Ra.i.dio Ga Ga"
...
<img class="art" src="https://res.cloudinary.com/dwwbmrctk/image/upload/v1783026162/Pop_Loser_V6N8_c4lbmb.png" alt="A stylized image of a vintage FM radio">

While this brave new world of AI is also a hellscape of rapacious capitalism, the ability to bang out tiny pieces of hyper-specific software is pretty sweet. I dropped [Marktwain](https://github.com/poploser/Marktwain) last week on GitHub. It is not some earth-shattering thing, it's a simple markdown editor that does things that suit my specific idiosyncrasies. It's neat and probably not terribly useful to many people (though if you're writing a novel, it's worth a shot). 
...
A "grotesque" from <a href="https://publicdomainreview.org/collection/bon-mots-of-the-eighteenth-and-nineteenth-century-1897/">Bon-Mots of the Nineteenth Century</a> / Alice B. Woodward / 1897 

### <i class="fa-solid fa-skull-crossbones"></i> <i class="fa-solid fa-skull-crossbones"></i> <i class="fa-solid fa-skull-crossbones"></i>

#### Confusions. 
*Subway Takes* and the tyranny of [web video shows](https://www.newyorker.com/culture/infinite-scroll/kareem-rahma-and-the-tyranny-of-web-video-shows): ==❝If the show is the medium, the clip is the message: an entire video shoot reduced to its catchiest few seconds, reaping the maximum amount of attention with the minimum of content.❞== / ⚱️ [James Burrows](https://www.nytimes.com/2026/06/19/arts/television/james-burrows-dead.html), [David Hockney](https://www.newyorker.com/culture/postscript/david-hockneys-hidden-depths) and [Om Malik](https://www.nytimes.com/2026/06/26/technology/om-malik-dead.html) died. / 📰 When one [4Columns](https://www.4columns.org/about/the-end-of-4columns) shuts, another *[Starlog](https://starlog.com/)* (re)opens, or something. / 🎥 David Thompson and AO Scott [reckon with being film critics](https://www.nytimes.com/2026/06/19/books/review/david-thomson-movies.html): ==❝Of course, interesting movies continue to be made, and now and then crowds of people still leave the house to see them [...] But the longstanding habit, among critics and other devotees, of holding movies apart from and superior to all the other screened content may involve a crucial category error. Could it be that, instead of being distinct from television, streaming, TikTok, A.I. slop and all the other screen forms, movies are actually their common ancestor, their home planet, the H.R. Giger alien xenomorph that has replicated itself across the universe of human consciousness?❞==

### <i class="fa-solid fa-skull-crossbones"></i> <i class="fa-solid fa-skull-crossbones"></i> <i class="fa-solid fa-skull-crossbones"></i>

#### Extensions. 
📺 The official *[Mister Rogers' Neighborhood](https://www.youtube.com/@MisterRogersNeighborhood/featured)* YouTube channel. / 🛠️ [brevio](https://brevio.pro/), free browser tools. / [TownSquare](https://townsquare.cauenapier.com/), so people can hang out on your website. / ⚾ [Ribbie](https://ribbie.tv/), 8-bit baseball. / 📚 [BannedBookLibrary](https://codeberg.org/rickoooooo/BannedBookLibrary), banned books hidden inside light bulbs. / [Faded Page](https://www.fadedpage.com/index.php), free public domain books. / 🎹 [MCP 2000](https://www.mcp2000.com/), browser-based sampler. / [stemdeck](https://github.com/stemdeckapp/stemdeck), wish this existed in my club days. / [Minedrums](https://10kdrummachines.com/machines/minesweeper/minesweeper). 
